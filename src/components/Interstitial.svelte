<script>
    ...
    $: {
        ...
        currQuestionIndex = quiz.questions.findIndex(q => q.slug === 'i/' + params.slug)
...
<div id={'question-'+currQuestionIndex} class='interstitial' in:fade={{duration: 500}}>
    <div class='content'>
